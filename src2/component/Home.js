...
const Home = () => {
  ...
  const endSwip = (e) => {
    ...
    setShiftRecord((prev) => {
      ...
      createShiftRecord(newShiftRecord)
        .then((response) => {
    ...
    navigate("/swipe", {
      state: {
        ...
        swipeStartTime: swipeStartTime
          ? swipeStartTime.toLocaleTimeString()
          : "",
      },
    });
  };
                ...
                >
                  <div>
                    {holidays.map((holiday, index) => (
                      <span key={index}>
                        <b>{new Date(holiday.date).toLocaleDateString()}</b> -{" "}
                        {holiday.name}
                        <br />
                        <br />
                      </span>
